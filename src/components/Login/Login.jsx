...
//             className="w-full p-2 border-2 rounded focus:ring-2 focus:ring-blue-600"
//             required
//           />
...
//           <Link to="/forgetpass">
//             <p className="my-3 text-center text-blue-500 font-bold">
//               Forgot Password ?
//             </p>
//           </Link>
//           <button
...
//               <Link className="text-blue-500 ps-1" to="/register">
//                 Register
//               </Link>
//             </span>
//           </div>
